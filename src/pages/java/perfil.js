document.addEventListener("DOMContentLoaded", async()=>{
    ...
    <div class ="relative">
       <button id="user-menu-btn"
            class="w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold text-xl shadow-md hover:scale-105 transition-transform cursor-pointer">
